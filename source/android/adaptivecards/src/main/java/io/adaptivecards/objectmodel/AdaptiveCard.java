...
public class AdaptiveCard {
  ...
  public AdaptiveCard(String version, String fallbackText, SWIGTYPE_p_std__shared_ptrT_BackgroundImage_t backgroundImage, ContainerStyle style, String speak, String language, VerticalContentAlignment verticalContentAlignment, HeightType height) {
    this(AdaptiveCardObjectModelJNI.new_AdaptiveCard__SWIG_3(version, fallbackText, SWIGTYPE_p_std__shared_ptrT_BackgroundImage_t.getCPtr(backgroundImage), style.swigValue(), speak, language, verticalContentAlignment.swigValue(), height.swigValue()), true);
  }

  public AdaptiveCard(String version, String fallbackText, SWIGTYPE_p_std__shared_ptrT_BackgroundImage_t backgroundImage, ContainerStyle style, String speak, String language, VerticalContentAlignment verticalContentAlignment, HeightType height, BaseCardElementVector body, BaseActionElementVector actions) {
    this(AdaptiveCardObjectModelJNI.new_AdaptiveCard__SWIG_4(version, fallbackText, SWIGTYPE_p_std__shared_ptrT_BackgroundImage_t.getCPtr(backgroundImage), style.swigValue(), speak, language, verticalContentAlignment.swigValue(), height.swigValue(), BaseCardElementVector.getCPtr(body), body, BaseActionElementVector.getCPtr(actions), actions), true);
  }
  ...
  public SWIGTYPE_p_std__shared_ptrT_BackgroundImage_t GetBackgroundImage() {
    return new SWIGTYPE_p_std__shared_ptrT_BackgroundImage_t(AdaptiveCardObjectModelJNI.AdaptiveCard_GetBackgroundImage(swigCPtr, this), true);
  }

  public void SetBackgroundImage(SWIGTYPE_p_std__shared_ptrT_BackgroundImage_t value) {
    AdaptiveCardObjectModelJNI.AdaptiveCard_SetBackgroundImage(swigCPtr, this, SWIGTYPE_p_std__shared_ptrT_BackgroundImage_t.getCPtr(value));
  }
