...
public class ColumnRenderer extends BaseCardElementRenderer
{
            ...
            ContainerStyle containerStyle)
    {
        ...
        BackgroundImage backgroundImage = column.GetBackgroundImage();
        if (backgroundImage != null && !backgroundImage.GetUrl().isEmpty())
        {
            BackgroundImageLoaderAsync loaderAsync = new BackgroundImageLoaderAsync(renderedCard, context, returnedView, hostConfig.GetImageBaseUrl(), backgroundImage);
