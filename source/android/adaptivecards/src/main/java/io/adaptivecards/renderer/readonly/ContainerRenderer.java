...
public class ContainerRenderer extends BaseCardElementRenderer
{
            ...
            ContainerStyle containerStyle)
    {
        ...
        BackgroundImage backgroundImage = container.GetBackgroundImage();
        if (backgroundImage != null && !backgroundImage.GetUrl().isEmpty())
        {
            BackgroundImageLoaderAsync loaderAsync = new BackgroundImageLoaderAsync(renderedCard, context, containerView, hostConfig.GetImageBaseUrl(), backgroundImage);
            ...
            loaderAsync.execute(backgroundImage.GetUrl());
        }
