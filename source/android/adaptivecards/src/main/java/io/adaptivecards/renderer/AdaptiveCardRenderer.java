...
public class AdaptiveCardRenderer
{
                               ...
                               boolean isInlineShowCard)
    {
        ...
        BackgroundImage backgroundImage = adaptiveCard.GetBackgroundImage();
        if (backgroundImage != null && !backgroundImage.GetUrl().isEmpty())
        {
            BackgroundImageLoaderAsync loaderAsync = new BackgroundImageLoaderAsync(renderedCard, context, layout, hostConfig.GetImageBaseUrl(), backgroundImage);
